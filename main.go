...
import (
	...
	"www.github.com/airren/cnat-kubebuilder/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f654d332.bytegopher.com",
	...
	if err = (&controllers.CronJobAtReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "CronJobAt")
		os.Exit(1)
	}
